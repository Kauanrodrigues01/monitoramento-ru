...
class TestGetSnapshotStatusService:
    def test_should_return_snapshot_status_service_instance(self):
        session = MagicMock(spec=AsyncSession)

        service = get_snapshot_status_service(session)

        assert isinstance(service, SnapshotStatusService)
